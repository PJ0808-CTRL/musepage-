...
export default function CustomizePage() {
  ...
  const [ogImageUrl, setOgImageUrl] =
    useState("");
  ...
  async function loadSite() {
    ...
    setGradientColor2(
      siteData.gradient_color_2 || "#18181b"
    );

    setGradientDirection(
      siteData.gradient_direction || "135deg"
    );
    ...
    setBackgroundPosition(
      siteData.background_position || "center"
    );
  ...
  function getBackgroundStyle(): React.CSSProperties {
    ...
    if (
      ...
      return {
        ...
        backgroundImage:
          `linear-gradient(rgba(0,0,0,${backgroundOverlay / 100}), rgba(0,0,0,${backgroundOverlay / 100})), url("${backgroundImageUrl}")`,
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-500">
                    Control how your profile appears in
                    search engines and when shared online.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs leading-5 text-gray-600">
                      Separate keywords with commas. This is
                      optional and modern search engines may
                      largely ignore this field.
                    </p>
                  </div>
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <p className="mt-1 text-xs leading-5 text-gray-500">
                      The image platforms can use when someone
                      shares your profile link.
                    </p>
                  </div>
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <p className="mt-1 text-xs leading-5 text-gray-500">
                      Image used for your profile's X/Twitter
                      link preview.
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-gray-500">
                    Choose whether search engines such as Google
                    should be allowed to index your profile.
                  </p>
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs leading-5 text-gray-600">
                    Optional. Use this when you want search engines
                    to treat another URL as the primary version of
                    this profile.
                  </p>
                </div>
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              >
                ...
                <p className="mt-8 text-center text-[10px] opacity-30">
